...
dependencies {
    // -------------------------------------------------------------------------
    // 1. AVF SYSTEM API STUBS (Fixes unresolved android.system.virtualmachine.*)
    // -------------------------------------------------------------------------
//    compileOnly(files("libs/framework-virtualization-stubs.jar"))
//    compileOnly(files("libs/framework-virtualization-stubs.jar"))
    compileOnly(files("${android.sdkDirectory}/platforms/android-36/optional/framework-virtualization.jar"))
    compileOnly(files("libs/framework-virtualization-real-stubs.jar"))
    // -------------------------------------------------------------------------
...
//    implementation(libs.androidx.virt.app)
